...
//            var names = getArtistsNames(em, "%gu%");
...
//                            .forEach(System.out::println);
    ...
    private static Stream<Tuple> getArtistsNames(EntityManager em, String matchedValue){
        ...
        String jpql = "SELECT a.artist_id as id, a.artist_name name FROM Artist a WHERE a.artist_name LIKE :partialName";
    ...
    private static Stream<Artist> getArtistBuilder(EntityManager em, String matchedValue){
        ...
        criteriaQuery.select(root)
                .where(builder.like(root.get("artist_name"), matchedValue))
